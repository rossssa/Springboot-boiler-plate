...
import com.example.aboutbook.file.GetS3Res;
...
public class S3Service {
    ...
    // 파일 형식이 잘못된 경우를 확인하기 위해 만들어진 로직, 파일 타입과 상관없이 업로드 하기위해 .의 존재 유무만 판단
    ...
    public List<GetS3Res> uploadFile(List<MultipartFile> multipartFiles) {
        ...
        // forEach 구문으로 multipartFile로 넘어온 파일들 하나씩 fileList에 추가
    ...
    public void deleteFile(String fileName) { s3Client.deleteObject(new DeleteObjectRequest(bucket, fileName));}
